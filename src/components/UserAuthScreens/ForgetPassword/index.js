            ...
            >
                <main className='auth-container max-w-md mx-auto' style={{boxShadow: 'none'}}>
                    ...
                    <div className='w-full flex flex-col md:flex-row items-center gap-3 mb-28'>
                        ...
                        <button className="bg-primary w-full md:w-auto text-white whitespace-nowrap px-32 py-10 rounded-5 transition-all hover:bg-purple-700 relative top-0 hover:top-px" >Send</button>
                    </div>
                </main>
            </ReactModal>
