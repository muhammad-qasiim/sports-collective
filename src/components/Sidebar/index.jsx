...
const Sidebar = ({ toggleSidebar }) => {
    return (
        <>
            <main className={`fixed bottom-0 right-0 left-0 top-16 z-10 transition-all ${toggleSidebar ? 'sidebar-container' : 'bg-transparent pointer-events-none'}`} style={{marginLeft: '0px'}}>
