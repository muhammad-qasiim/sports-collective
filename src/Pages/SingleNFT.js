            ...
            <div className="w-full mt-8 mb-32 xl:mb-10">
              ...
              <section className='border rounded-8 my-22 pt-18'>
                ...
                <div className='px-24 bg-gray-50 pt-14 pb-18'>
                  ...
                  <p className="text-34 text-gray-700 leading-48 pr-0 lg:pr-112">beglobal is the world's first and largest NFT marketplace</p>
                  <button className="bg-red-500 text-white px-44 py-10 rounded-5 transition-all hover:bg-red-600 relative top-0 hover:top-px mt-22" >Place Bid</button>
